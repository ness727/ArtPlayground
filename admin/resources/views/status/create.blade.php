...
<form name="form1" method="post" action="{{ route('status.store') }}{{ $tmp }}" class="flex flex-col items-center justify-center py-24">
@csrf
	<div class="w-2/3">
		<div class="font-bold text-2xl py-4">상태 추가</div>
	</div>
    <table class="bg-white w-2/3">
		...
		<tr>
			...
			<td class="text-center py-3 px-4">
				...
				<a href="{{ route('status.index') }}{{ $tmp }}" class="bg-gray-500 hover:bg-gray-800 text-white px-8 py-2 m-2">뒤로가기</a>
			</td>
		</tr>
    </table>
</form>
