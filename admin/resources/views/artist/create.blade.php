...
<form name="form1" method="post" action="{{ route('artist.store') }}{{ $tmp }}" class="flex flex-col items-center justify-center py-24">
@csrf
	<div class="w-2/3">
		<div class="font-bold text-2xl py-4">화가 추가</div>
	</div>
