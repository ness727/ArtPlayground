        ...
        <div class="w-full px-4">
          <div
            ...
            <h3 class="mb-10 text-center text-xl font-semibold  text-dark dark:text-white">
              ...
              <div class="mb-[22px]">
              <p class="text-base text-body-secondary mb-2">이름 </p>
              ...
              <div class="mb-[22px]">
              <p class="text-base text-body-secondary mb-2">아이디 </p>
                <input type="text"  name="user_id" value="{{ $userData->user_id }}" disabled
                  class="text-center border-stroke dark:border-dark-3 bg-transparent w-3/4 rounded-md border py-3 px-5 text-base text-body-color dark:text-dark-6 placeholder:text-dark-6 outline-none transition focus:border-primary dark:focus:border-primary focus-visible:shadow-none" />
              </div>
              <div class="mb-[22px]">
              <p class="text-base text-body-secondary mb-2">주소 </p>
                <input type="text" name="user_id" value="{{ $userData->address }}" disabled
                  class="text-center border-stroke dark:border-dark-3 bg-transparent w-full rounded-md border py-3 px-5 text-base text-body-color dark:text-dark-6 placeholder:text-dark-6 outline-none transition focus:border-primary dark:focus:border-primary focus-visible:shadow-none" />
                  <a href="{{ url('changeaddress') }}" class="text-primary hover:underline">
                    주소 변경하기
                  </a>
                </div>
            ...
            <p class="text-base text-body-secondary">
              비밀번호를 변경하고 싶으시다고요?<br/>
              <a href="{{ url('changepassword') }}" class="text-primary hover:underline">
                여기를 클릭하세요.
              </a>
            </p>
