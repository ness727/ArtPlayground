...
<body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://source.unsplash.com/1L71sPT5XKc');">
  ...
  <div class="max-w-4xl flex justify-center items-center h-auto mt-100 flex-wrap mx-auto my-32">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">이름: {{ $user->name }}</p>
			<p class="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">아이디: {{ $user->user_id }}</p>
			<p class="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">이메일: {{ $user->email }}</p>
			<p class="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">핸드폰 번호: {{ $user->phone }}</p>
			<p class="pt-2 text-base font-bold flex items-center justify-center lg:justify-start">주소: [{{ $user->zipcode }}] {{ $user->address1 }} {{ $user->address2 }}</p>
			
			<div class="pt-12 pb-8">
				<button class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
					<a href="{{ route('user.edit', $user->id) }}">내 정보 수정</a>
				</button> 
			</div>
	...
	<div class="flex items-center  mx-6 lg:mx-0">
	  <div class="cardWrap flex">
		  ...
		  <div class="card cardRight p-10 z-10">
			<div class="number">
			  <h3>156</h3>
			  <span>seat</span>
			</div>
		...
		<div class="flex h-48 px-5 align-middle w-full rounded-lg lg:rounded-l-lg lg:rounded-l-none shadow-2xl bg-white opacity-75">
			<p class="text-base font-bold flex items-center justify-center lg:justify-start">사용 가능</p>
		</div>
	</div>
