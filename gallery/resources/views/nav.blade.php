<div class="absolute top-0 left-0 z-40 flex items-center w-full bg-transparent ud-header">
    <div class="container">
      <div class="relative flex items-center justify-between -mx-4 ">
        <div class="max-w-full px-4 " style="width: 18rem;">
          <a href="{{ url('/') }}" style="color:#000;" class=" flex py-2 mx-8 text-xl font-semibold text-dark dark:text-white lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
        ...
        <div class="flex items-center justify-between w-full px-4">
            ...
            <nav id="navbarCollapse"
              ...
              <ul class="blcok lg:flex 2xl:ml-20">
                <li class="relative group">
                  <a href="{{ url('/') }}"
                    class="flex py-2 mx-8 text-base font-medium text-dark dark:text-white lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                    Home
                  </a>
                </li>
				
				
				@if (Cookie::get('premium'))
				<li class="relative group">
          ...
          <div class="flex items-center justify-end pr-16 lg:pr-0">
            ...
            <div class="hidden sm:flex">
              <a href="{{ url('login') }}" class="loginBtn py-2 px-[22px] text-base font-medium text-white hover:opacity-70">
                Log In
              </a>
              <a href="{{ url('register') }}"
			  ...
			  <a href="{{ url('logout') }}"
                class="loginBtn py-2 px-[22px] text-base font-medium text-white hover:opacity-70">
                Log out
              </a>
			 @endif
            </div>
