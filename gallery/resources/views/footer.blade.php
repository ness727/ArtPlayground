      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
          <div class="w-full mb-10">
            ...
            <p class="mb-8 max-w-[270px] text-base text-gray-7">
              인덕대학교 컴퓨터소프트웨어학과 23학년도 2학년 2학기 PHPFramework 기말 팀프로젝트 : 미술관 홈페이지 만들기 - 1조
            </p>
        ...
        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
          <div class="w-full mb-10">
            ...
            <ul>
              <li>
                <a href="{{ url('/') }}" class="inline-block mb-3 text-base text-gray-7 hover:text-primary">
                  Home
                </a>
              </li>
              <li>
                <a href="{{ url('ticket') }}" class="inline-block mb-3 text-base text-gray-7 hover:text-primary">
                  Ticket
                </a>
              </li>
              <li>
