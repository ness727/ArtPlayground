        ...
        <div class="w-full px-4">
          <div
            ...
            <form action="{{ route('updatepassword') }}" method="POST">
              ...
              <div class="mb-[22px]">
                <input type="password" name="password" value="" placeholder="기존 비밀번호"
                  class="text-center border-stroke dark:border-dark-3 bg-transparent w-3/4 rounded-md border py-3 px-5 text-base text-body-color dark:text-dark-6 placeholder:text-dark-6 outline-none transition focus:border-primary dark:focus:border-primary focus-visible:shadow-none" />
              </div>

              <div class="mb-[22px]">
                <input type="password" name="newpassword" value="" placeholder="새로운 비밀번호"
                  class="text-center border-stroke dark:border-dark-3 bg-transparent w-3/4 rounded-md border py-3 px-5 text-base text-body-color dark:text-dark-6 placeholder:text-dark-6 outline-none transition focus:border-primary dark:focus:border-primary focus-visible:shadow-none" />
              </div>
              
              <div class="mb-[22px]">
                <input type="password" name="newpasswordconfirm" value="" placeholder="새로운 비밀번호 확인"
                  class="text-center border-stroke dark:border-dark-3 bg-transparent w-3/4 rounded-md border py-3 px-5 text-base text-body-color dark:text-dark-6 placeholder:text-dark-6 outline-none transition focus:border-primary dark:focus:border-primary focus-visible:shadow-none" />
              </div>
              <div class="mb-9">
                <input type="submit" value="변경하기"
                  class="border-primary w-1/3 cursor-pointer rounded-md border bg-primary py-3 px-5 text-base text-white transition duration-300 ease-in-out hover:bg-blue-dark" />
              </div>
            </form>
